...
parser.add_argument(
    ...
    default=False,
    type=str2bool,
    help="compatibility flag for annotation variants; EvoEdit derives targets online",
)
...
# Backbone and parameter-efficient tuning. Defaults mirror TIM Stage I's script.
...
parser.add_argument("--freeze_vm", default=False, type=str2bool)
...
# EvoEdit objective weights and stability controls.
parser.add_argument("--prior_report_weight", default=1.0, type=float)
...
parser.add_argument("--gate_loss_weight", default=0.2, type=float)
...
parser.add_argument("--operation_focal_gamma", default=2.0, type=float)
parser.add_argument(
    "--operation_class_weights",
    nargs=6,
    type=float,
    default=[1.0, 3.0, 3.0, 4.0, 4.0, 2.0],
    metavar=("KEEP", "APPEAR", "RESOLVE", "WORSEN", "IMPROVE", "UNCERTAIN"),
)
parser.add_argument("--active_keep_weight", default=0.05, type=float)
parser.add_argument("--gate_non_keep_weight", default=3.0, type=float)
parser.add_argument("--confidence_non_keep_weight", default=2.0, type=float)
...
# Optimization: shared values match TIM Stage I's launch script.
parser.add_argument("--learning_rate", default=1e-4, type=float)
parser.add_argument("--weight_decay", default=0.01, type=float)
parser.add_argument("--gradient_clip_val", default=1.0, type=float)

# Decoding: kept identical to TIM Stage I's official launch script.
...
# PyTorch Lightning: defaults mirror the two-GPU TIM Stage I launch.
